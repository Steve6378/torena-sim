...
//! tasks at the marked seams. `on_prepare` takes a round context instead of a
...
impl Runner {
    ...
    pub fn create(
        ...
        Runner {
            ...
            lane_move_outward: false,
            is_side_blocked: false,
            lane_mode: crate::runner::lane::LaneMode::Normal,
            overtake_linger_left: 0.0,
            front_blocker: None,
            is_overtaking: false,
            ...
            activations_at_tick_start: 0,
            activations_at_last_tick_start: 0,
